...
export class AiApi extends runtime.BaseAPI {
     ...
     */
    async getAdminAiHealthRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: any; }>> {
     ...
     * Get AI assistant health status
     */
    async getAdminAiHealth(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: any; }> {
    ...
    async headAdminAiChat(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.headAdminAiChatRaw(initOverrides);
    }
     ...
     */
    async postAdminAiChatStreamRaw(requestParameters: PostAdminAiChatStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: any; }>> {
        if (requestParameters['chatRequest'] == null) {
            throw new runtime.RequiredError(
                'chatRequest',
     ...
     * Proxy AI assistant streaming chat request
     */
    async postAdminAiChatStream(requestParameters: PostAdminAiChatStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: any; }> {
