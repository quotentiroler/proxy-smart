...
class TestFhirServerInfo(unittest.TestCase):
    """FhirServerInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FhirServerInfo:
        """Test FhirServerInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FhirServerInfo`
        """
        model = FhirServerInfo()
        if include_optional:
