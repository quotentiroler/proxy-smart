...
class PostAdminLaunchContextsByUserIdFhirContextRequest(BaseModel):
    """
    PostAdminLaunchContextsByUserIdFhirContextRequest
    """ # noqa: E501
    fhir_context: StrictStr = Field(description="Additional FHIR resources in context (JSON array of objects)", alias="fhirContext")
    __properties: ClassVar[List[str]] = ["fhirContext"]
