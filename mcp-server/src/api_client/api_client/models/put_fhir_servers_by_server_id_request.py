...
class PutFhirServersByServerIdRequest(BaseModel):
    """
    PutFhirServersByServerIdRequest
    """ # noqa: E501
    url: StrictStr = Field(description="New FHIR server base URL")
    name: Optional[StrictStr] = Field(default=None, description="Optional custom name for the server")
