...
class PutAdminHealthcareUsersByUserIdRequest(BaseModel):
    """
    ...
    enabled: Optional[StrictBool] = Field(default=None, description="Whether user is enabled")
    ...
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "email", "enabled", "organization", "fhirUser", "realmRoles", "clientRoles"]
