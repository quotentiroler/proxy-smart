...
class PutAdminSmartAppsByClientIdRequest(BaseModel):
    """
    ...
    enabled: Optional[StrictBool] = Field(default=None, description="Whether application is enabled")
    ...
    smart_version: Optional[StrictStr] = Field(default=None, description="SMART version", alias="smartVersion")
    fhir_version: Optional[StrictStr] = Field(default=None, description="FHIR version", alias="fhirVersion")
    __properties: ClassVar[List[str]] = ["name", "description", "enabled", "redirectUris", "webOrigins", "defaultScopes", "optionalScopes", "smartVersion", "fhirVersion"]
