...
class PostAuthIntrospectRequest(BaseModel):
    """
    PostAuthIntrospectRequest
    """ # noqa: E501
    token: StrictStr = Field(description="The token to introspect")
    token_type_hint: Optional[StrictStr] = Field(default=None, description="Hint about the token type (access_token, refresh_token)")
