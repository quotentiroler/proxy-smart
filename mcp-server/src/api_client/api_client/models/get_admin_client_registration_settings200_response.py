...
class GetAdminClientRegistrationSettings200Response(BaseModel):
    """
    ...
    admin_approval_required: StrictBool = Field(description="Whether admin approval is required for new clients", alias="adminApprovalRequired")
    ...
    max_redirect_uris: Union[StrictFloat, StrictInt] = Field(description="Maximum number of redirect URIs per client", alias="maxRedirectUris")
