...
class PostAuthTokenRequest(BaseModel):
    ...
    """ # noqa: E501
    grant_type: StrictStr = Field(description="OAuth grant type (e.g., authorization_code, client_credentials, password)")
    code: Optional[StrictStr] = Field(default=None, description="Authorization code for exchange")
    redirect_uri: Optional[StrictStr] = Field(default=None, description="Redirect URI for authorization code flow")
    ...
    code_verifier: Optional[StrictStr] = Field(default=None, description="PKCE code verifier for security")
    refresh_token: Optional[StrictStr] = Field(default=None, description="Refresh token for refresh_token grant")
    scope: Optional[StrictStr] = Field(default=None, description="Requested scopes")
    audience: Optional[StrictStr] = Field(default=None, description="Audience for the token request")
    ...
    client_assertion: Optional[StrictStr] = Field(default=None, description="Client assertion JWT for Backend Services authentication")
