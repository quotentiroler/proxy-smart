...
class PutAdminIdpsByAliasRequest(BaseModel):
    """
    PutAdminIdpsByAliasRequest
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, alias="displayName")
    enabled: Optional[StrictBool] = None
    config: Optional[PostAdminIdpsRequestConfig] = None
    __properties: ClassVar[List[str]] = ["displayName", "enabled", "config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": PostAdminIdpsRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
