...
class GetMonitoringOauthEvents200ResponseEventsInnerFhirContext(BaseModel):
    """
    GetMonitoringOauthEvents200ResponseEventsInnerFhirContext
    """ # noqa: E501
    patient: Optional[StrictStr] = None
    encounter: Optional[StrictStr] = None
    location: Optional[StrictStr] = None
    fhir_user: Optional[StrictStr] = Field(default=None, alias="fhirUser")
