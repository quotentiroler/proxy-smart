...
class GetAuthConfig200Response(BaseModel):
    """
    GetAuthConfig200Response
    """ # noqa: E501
    keycloak: GetAuthConfig200ResponseKeycloak
    __properties: ClassVar[List[str]] = ["keycloak"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keycloak": GetAuthConfig200ResponseKeycloak.from_dict(obj["keycloak"]) if obj.get("keycloak") is not None else None
        })
        return _obj
