...
class PutAdminLaunchContextsByUserIdSmartStyleUrlRequest(BaseModel):
    """
    PutAdminLaunchContextsByUserIdSmartStyleUrlRequest
    """ # noqa: E501
    style_url: StrictStr = Field(description="URL to CSS stylesheet for styling", alias="styleUrl")
    __properties: ClassVar[List[str]] = ["styleUrl"]
