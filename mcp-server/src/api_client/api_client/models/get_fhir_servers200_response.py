...
class GetFhirServers200Response(BaseModel):
    """
    GetFhirServers200Response
    """ # noqa: E501
    total_servers: Union[StrictFloat, StrictInt] = Field(description="Total number of configured FHIR servers", alias="totalServers")
    servers: List[GetFhirServers200ResponseServersInner]
    __properties: ClassVar[List[str]] = ["totalServers", "servers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "servers": [GetFhirServers200ResponseServersInner.from_dict(_item) for _item in obj["servers"]] if obj.get("servers") is not None else None
        })
        return _obj
