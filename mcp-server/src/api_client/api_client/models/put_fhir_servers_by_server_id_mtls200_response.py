...
class PutFhirServersByServerIdMtls200Response(BaseModel):
    """
    PutFhirServersByServerIdMtls200Response
    """ # noqa: E501
    success: StrictBool = Field(description="Whether the update was successful")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": PutFhirServersByServerIdMtls200ResponseConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
