...
class TokenResponse(BaseModel):
    ...
    fhir_context: Optional[List[FhirContextItem]] = Field(default=None, description="Additional FHIR resources in context", alias="fhirContext")
    ...
    authorization_details: Optional[List[AuthorizationDetail]] = Field(default=None, description="Authorization details for multiple FHIR servers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fhirContext": [FhirContextItem.from_dict(_item) for _item in obj["fhirContext"]] if obj.get("fhirContext") is not None else None,
            "intent": obj.get("intent"),
            "smart_style_url": obj.get("smart_style_url"),
            "tenant": obj.get("tenant"),
            "need_patient_banner": obj.get("need_patient_banner"),
            "authorization_details": [AuthorizationDetail.from_dict(_item) for _item in obj["authorization_details"]] if obj.get("authorization_details") is not None else None,
            "error": obj.get("error"),
