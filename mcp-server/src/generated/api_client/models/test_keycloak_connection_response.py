...
class TestKeycloakConnectionResponse(BaseModel):
    """
    ...
    error: Optional[StrictStr] = Field(default=None, description="Error message if connection failed")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "message", "error"]
