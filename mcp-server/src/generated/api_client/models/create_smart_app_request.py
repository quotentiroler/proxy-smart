...
class CreateSmartAppRequest(BaseModel):
    ...
    allowed_server_ids: Optional[List[StrictStr]] = Field(default=None, description="List of allowed FHIR server IDs (when serverAccessType is selected-servers)", alias="allowedServerIds")
    ...
    require_pkce: Optional[StrictBool] = Field(default=None, description="Require Proof Key for Code Exchange (PKCE) for public clients", alias="requirePkce")
