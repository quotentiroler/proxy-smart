...
class FhirServerList(BaseModel):
    """
    FhirServerList
    """ # noqa: E501
    total_servers: Union[StrictFloat, StrictInt] = Field(description="Total number of configured servers", alias="totalServers")
    servers: List[FhirServerListServersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "servers": [FhirServerListServersInner.from_dict(_item) for _item in obj["servers"]] if obj.get("servers") is not None else None
        })
