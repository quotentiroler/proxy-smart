...
class IntrospectRequest(BaseModel):
    ...
    IntrospectRequest
    """ # noqa: E501
    token: StrictStr = Field(description="Token to introspect")
    token_type_hint: Optional[StrictStr] = Field(default=None, description="Hint about token type (access_token, refresh_token)")
